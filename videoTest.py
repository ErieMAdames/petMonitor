...
from picamera2 import Picamera2  # Use MjpegEncoder for streaming output
        ...
        if self.path == '/':
            ...
            try:
                while True:
                    ...
                    output_data = network_group.run({input_vstream_info.name: input_tensor})
...
picam2.encoder = JpegEncoder()  # Set MJPEG encoder
picam2.start_recording(output)  # Use custom StreamingOutput
